...
def initialize():
	...
	global child_, examiner_, social_
	global start, end
	global info_
	global duration_
...
def saveJson(filename, info_, duration_, social_):
	...
	jsonFile.write(
		...
		"\"socialbid\"" + ":"  + json.dumps(social_, indent=4, separators=(',', ': ')) +  "}"
	)
...
def main(argv):
	...
	saveJson("test-modified", info_, duration_, social_)
